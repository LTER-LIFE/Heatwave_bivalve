...
image2D(
  ...
  main = title1,
  clab = "°C",
  contour = list(levels = c(0, 5, 10, 12.5, 15, 20, 25, 30), labcex = 1.2),
  zlim = c(0, 30),
  colkey = list(dist = 0.08)  # default is 0, increase to move right
)


axis(1, at = c(DT.day[1], DT.day[length(DT.day)/3], DT.day[length(DT.day)*2/3], DT.day[length(DT.day)]), labels = c("Nov","Mar","Jul","Nov"), las = 1)
